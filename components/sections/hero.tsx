    ...
    return (
        <section className="relative flex-1 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('images/hero-bg.jpg')" }}>
            ...
            <div className="relative mx-auto w-full max-w-[1534px] px-4 py-10 md:px-6 lg:px-8">
                <h1 className="uppercase text-white tracking-tight leading-[0.95] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl"><span className="text-[var(--color-gold)]">Строим премиальные дома</span><br></br>
